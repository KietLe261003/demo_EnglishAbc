    ...
    return (
        ...
        {percent < 30 ? (
          <div className="relative w-[240px] h-[138px] bg-black bg-opacity-70 p-4 rounded-t-[25px]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[#FF774C] text-5xl font-bold">{percent}%</span>
            </div>
          </div>
        ) : null}
        {percent >= 30 && percent < 70 ? (
          <div className="relative w-[240px] h-[138px] bg-black bg-opacity-70 p-4 rounded-t-[25px]">
            ...
            ></div>
            <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[#FB9400] text-5xl font-bold">{percent}%</span>
            </div>
          </div>
        ) : null}
        ...
        <div className="relative w-[240px] h-[138px] bg-black bg-opacity-70 p-4 rounded-t-[25px]">
          ...
          ></div>
          <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[#00A751] text-5xl font-bold">{percent}%</span>
            </div>
        </div>
        ...
        <div className="relative w-[240px] h-[138px] bg-black bg-opacity-70 p-4 rounded-t-[25px]">
          ...
          ></div>
          <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-[#00A751] text-2xl rounded-xl font-bold border-2 border-[#00A751] px-2 py-1 ">Đã hoàn thành</span>
            </div>
        </div>
